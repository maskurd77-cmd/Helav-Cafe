...
import { ReceiptText, Search, Calendar as CalendarIcon, X, Eye, Clock, Printer } from 'lucide-react';
      ...
      iframeDoc.write(`
        <html dir="rtl" lang="ku">
          ...
          <body>
            ...
            <div class="powered-by">POWERED BY MAS MENU - REPRINT<br> <!-- Physical RJ11 drawer pulse character: \x1b\x70\x00\x19\xfa --> </div>
          </body>
        </html>
      `);
      iframeDoc.close();
                      ...
                      <div style={{ display: 'none' }}>
                        <div ref={printRef} className="receipt-container">
                           ...
                           <div className="date-row">
                             <span>{new Date(selectedOrder.date).toLocaleDateString('en-GB')}</span>
                             <span>{new Date(selectedOrder.date).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</span>
                           </div>
                           ...
                           <div className="total-row">
                             ...
                             <div className="total-amount">{selectedOrder.total.toLocaleString('en-US')} <span style={{fontSize: '12px', fontWeight: 'bold'}}>.IQD</span></div>
                           </div>
                        </div>
                      </div>
